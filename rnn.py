...
def bidirectional_dynamic_rnn(cell_fw, cell_bw, inputs, sequence_length=None,
															...
															swap_memory=False, time_major=False, scope=None, concatenate=True):
	...
	if concatenate:
		...
		# ctb = vs.get_variable(name='contribution_fw', dtype=dtypes.float32, shape=())
		# outputs = ctb*output_fw + (1 - ctb)*output_bw
		outputs = output_fw + output_bw
